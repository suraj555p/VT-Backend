...
import { getAllVideos, uploadVideo, getVideoById, getAllUserVideos, deleteVideo, getAllChannelVideos } from "../Controllers/Video.controller.js";
...
router.get('/getAllChannelVideos/:userId', verifyJWT,getAllChannelVideos);
